--统计2017-7月份至12月份完成工单
select DLNOffice.dbo.Users.UserId as 提交人,DLNOffice.dbo.Users.UserName as 姓名,DLNOffice.dbo.Users.IDNumber as 身份证号,sum(case when dt_order.state = 3 then 1 else 0 end) as 完成
...
group by DLNOffice.dbo.Users.UserId,DLNOffice.dbo.Users.IDNumber,DLNOffice.dbo.Users.UserName order by 完成 desc
